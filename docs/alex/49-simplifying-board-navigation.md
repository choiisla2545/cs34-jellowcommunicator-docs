...
2. Select the preferred number of category icons to display.
3. Choose from 1 to 9 icons per screen, depending on the child's needs.

A smaller number of icons may help children focus on specific choices, while a larger number provides access to more options at once.
...
1. Open a category or sequence.
2. Tap **Next** to move to the following step.
3. Tap **Previous** to return to the previous step.
4. Tap an icon to hear the associated word or phrase through the text-to-speech feature.

This can help children follow routines and learn vocabulary in a structured way.

### Exit a Category or Sequence

To return to the previous screen: Tap the **Back Arrow** located beside the **Home** button. The app will return to the previous view.
