...
3. Select the icons you want to add.
4. Tap **Next** to review your selections.
5. Preview the board layout.
...
4. Add or remove icons as needed.
...
4. Repeat for any additional icons you want to remove.
...
1. Open the board in **Edit Mode**.
2. Browse and select a category.
3. Choose one of the following options:
- **Select All** to add all icons from the category.
- **Reset** to clear the current category selection.
6. Tap **Next** to preview the board.
...
1. Open the board in **Edit Mode**.
2. Browse the available categories and select any icons you wish to add.
3. Tap **Next** to view the board preview.
4. Tap the **+ (Add Icon)** button.
5. Tap the **Camera** icon.
6. Choose one of the following options:
- Select an image from your device's gallery.
- Take a new photo using your camera.
7. Enter a name for the custom icon.
8. Tap **Continue**.
9. Edit the button phrases as needed.
...
1. Open the board in **Edit Mode**.
2. Locate the custom icon you want to remove.
3. Tap the custom icon to unselect it.
4. Tap **Next** to review the changes.
5. Tap **Save** to apply the changes.
