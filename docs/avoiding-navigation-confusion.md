...
- Always return to the *Home Screen* using the home button or main menu icon  
- Use only *one category at a time* to reduce clutter  
- Avoid rapidly switching between categories  
